...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\power-p4\functions", "$global:testroot\..\power-p4\internal\functions"),
...
$CommandPath = @(
    "$global:testroot\..\power-p4\functions"
    "$global:testroot\..\power-p4\internal\functions"
)
